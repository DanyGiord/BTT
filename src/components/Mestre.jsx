...
function Mestre() {
    return (
        <section class="pt-10 bg-[#191919] 2xl:py-24 2xl:bg-white sm:pt-16 md:pt-0">
            <div class="px-4 mx-auto rounded-md bg-[#191919] max-w-7xl sm:px-6 lg:px-8">
                <div class="2xl:pl-24">
                    <div class="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:gap-x-8 2xl:gap-x-20">
                        <div class="text-center md:py-16 xl:py-24 md:text-left">
                            ...
                            <h2 class="max-w-2xl font-bold mx-auto mt-4 text-2xl text-[#ccc] pb-3" data-aos='fade-right' data-aos-delay='500'>HEAD COACH</h2>
                            <blockquote>
                        ...
                        <div class="relative" data-aos='fade-down' data-aos-delay='400'>
                            <img class="md:absolute md:bottom-0 md:scale-110 md:origin-bottom-right lg:scale-75 2xl:scale-100 2xl:-mt-20 transition duration-500 hover:scale-105" src={mestre} alt="Fernando Paulon" />
                        </div>
                    </div>
                </div>
            </div>
